...
function M.get()
    return {
        ...
        Normal = { fg = C.fg, bg = O.transparent_background and C.none or C.base }, -- normal text
        NormalNC = {
            fg = C.fg,
        ...
        NormalSB = { fg = C.fg, bg = C.crust }, -- normal text in non-current windows
        NormalFloat = { fg = C.fg, bg = (O.transparent_background and vim.o.winblend == 0) and C.none or C.mantle }, -- Normal text in floating windows.
        FloatBorder = { fg = C.blue },
        Pmenu = {
            bg = (O.transparent_background and vim.o.pumblend == 0) and C.none or U.darken(C.surface0, 0.8, C.crust),
            fg = C.overlay2,
        }, -- Popup menu: normal item.
        PmenuSel = { fg = C.fg, bg = C.surface1, style = { "bold" } }, -- Popup menu: selected item.
        ...
        SpecialKey = { fg = C.fg }, -- Unprintable characters: text displayed differently from what it really is.  But not 'listchars' textspace. |hl-Whitespace|
        ...
        StatusLine = { fg = C.fg, bg = O.transparent_background and C.none or C.mantle }, -- status line of current window
        ...
        VisualNOS = { bg = C.bg3, style = { "bold" } }, -- Visual mode selection when vim is "Not Owning the Selection".
