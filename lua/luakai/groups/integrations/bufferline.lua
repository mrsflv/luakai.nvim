...
function M.get(user_config)
    ...
    return function()
        ...
        local inactive_bg = transparent_background and "NONE" or C.bg2

        local separator_fg = O.transparent_background and C.bg_dim or C.bg0
        ...
        local highlights = {
            ...
            tab_selected = { fg = C.red, bg = active_bg, bold = true },
            tab_separator = { fg = separator_fg, bg = inactive_bg },
            tab_separator_selected = { fg = C.orange, bg = active_bg },
            tab_close = { fg = C.red, bg = inactive_bg },
            indicator_selected = { fg = C.purple, bg = active_bg, style = styles },
            -- separators
            ...
            close_button_selected = { fg = C.blue, bg = active_bg },
            -- Empty fill
